...
class SourceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_source = NewsSource('cnn','CNN.','View the latest news and breaking news today for U.S., world, weather, entertainment, politics and health at CNN','https://www.nytimes.com/2018/08/31/sports/tennis/us-open-results.html')
